...
Original Source : https://www.ncdc.noaa.gov/isd
...
```{r}
stations_near_target = isd_stations_search(lat    =   44,  # degrees_north
                                           lon    = -103,  # degrees_east
                                           radius =  100)  # km

print(stations_near_target)
```

So for Rapid City Regional Airport (KRAP) which probably has the best reporting fidelity in this example's region since it's a First Order Station for NOAA, and for your period, you will want to use the following stationID pair.
...
```{r}
<<<<<<< HEAD
targ_data = isd(usaf = targ_usaf,  # your usaf number
                wban = targ_wban,  # your wban number
                year = targ_year,  # your year
                progress=TRUE)     # shows prograss as you go

print(targ_data)
=======
NCDC_data = isd(usaf = target_usaf,  # your usaf number
...
=======
NCDC_data$date_time = ymd_hm(sprintf("%s %s",
                                      as.character(NCDC_data$date),
                                      NCDC_data$time))

NCDC_data$date = NCDC_data$date_time 
>>>>>>> origin/master
...
=======
NCDC_data$temperature[NCDC_data$temperature == "+9999"]                   = NA 

NCDC_data$temperature_dewpoint[NCDC_data$temperature_dewpoint == "+9999"] = NA

NCDC_data$air_pressure[NCDC_data$air_pressure == "99999"]                 = NA

NCDC_data$wind_speed[NCDC_data$wind_speed == "9999"]                      = NA

NCDC_data$wind_direction[NCDC_data$wind_direction == "999"]               = NA
>>>>>>> origin/master
...
=======
NCDC_data = isd_transform(NCDC_data)

# patch the wind direction so it's 0 degrees when the wind speed is missing

NCDC_data$wind_direction[NCDC_data$wind_speed == 0] = 0
>>>>>>> origin/master
...
=======
NCDC_data$GF1_total_cloud_cover_fraction = as.numeric(NCDC_data$GF1_coverage)

# 00: None, SKC or CLR

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==00] = 0.00

# 01: One okta - 1/10 or less but not zero

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==01] = 1.0 / 8.0

# 02: Two oktas - 2/10 ‑ 3/10, or FEW

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==02] = 2.0 / 8.0

# 03: Three oktas - 4/10

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==03] = 3.0 / 8.0

# 04: Four oktas - 5/10, or SCT

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==04] = 4.0 / 8.0

# 05: Five oktas - 6/10

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==05] = 5.0 / 8.0

# 06: Six oktas - 7/10 ‑ 8/10

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==06] = 6.0 / 8.0

# 07: Seven oktas - 9/10 or more but not 10/10, or BKN

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==07] = 7.0 / 8.0

# 08: Eight oktas - 10/10, or OVC

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==08] = 8.0 / 8.0

# 09: Sky obscured, or cloud amount cannot be estimated

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==09] = 8.0 / 8.0

# 10: Partial obscuration

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==10] = 4.0 / 8.0

# 11: Thin scattered

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==11] = 2.0 / 8.0

# 12: Scattered

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==12] = 4.0 / 8.0

# 13: Dark scattered

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==13] = 5.0 / 8.0

# 14: Thin broken

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==14] = 6.0 / 8.0

# 15: Broken

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==15] = 7.0 / 8.0

# 16: Dark broken

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==16] = 8.0 / 8.0

# 17: Thin overcast

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==17] = 4.0 / 8.0

# 18: Overcast

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==18] = 8.0 / 8.0

# 19: Dark overcast

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==19] = 8.0 / 8.0

# 99: Missing

NCDC_data$GF1_total_cloud_cover_fraction[NCDC_data$GF1_total_cloud_cover_fraction==99] = NA
>>>>>>> origin/master
...
=======
plot(x       = NCDC_data$date_time,
     y       = NCDC_data$temperature, 
>>>>>>> origin/master
     type    = "l", 
     col     = "red", 
     lwd     = 1.5, 
...
=======
plot(x       = NCDC_data$date_time,
     y       = NCDC_data$temperature_dewpoint, 
>>>>>>> origin/master
     type    = "l", 
     col     = "darkgreen", 
     lwd     = 1.5, 
...
=======
plot(x       = NCDC_data$date_time,
     y       = NCDC_data$GF1_total_cloud_cover_fraction, 
>>>>>>> origin/master
     type    = "l", 
     col     = "grey", 
     lwd     = 1.5, 
...
=======
windrose_frame = data.frame(date      = NCDC_data$date_time,
                            ws        = NCDC_data$wind_speed,
                            wd        = NCDC_data$wind_direction,
                            longitude = NCDC_data$longitude,
                            latitude  = NCDC_data$latitude)
>>>>>>> origin/master
...
<<<<<<< HEAD
start_date = as.POSIXct(paste(targ_year,
=======
...
<<<<<<< HEAD
end_date   = as.POSIXct(paste(targ_year,
=======
...
=======
NCDC_time_series                  = data.frame(date = hour_time)

NCDC_time_series$temperature_degC = approx(x      = NCDC_data$date_time,
                                           y      = NCDC_data$temperature,
                                           method = "linear",
                                           xout   = hour_time)$y
                              
NCDC_time_series$dewpoint_degC    = approx(x      = NCDC_data$date_time,
                                           y      = NCDC_data$temperature_dewpoint,
                                           method = "linear",
                                           xout   = hour_time)$y 
                              
NCDC_time_series$cloud_fraction   = approx(x      = NCDC_data$date_time,
                                           y      = NCDC_data$GF1_total_cloud_cover_fraction,
                                           method = "linear",
                                           xout   = hour_time)$y 
                              
NCDC_time_series$press_msl_hPa    = approx(x      = NCDC_data$date_time,
                                           y      = NCDC_data$air_pressure,
                                           method = "linear",
                                           xout   = hour_time)$y
                              
NCDC_time_series$wind_spd_ms      = approx(x      = NCDC_data$date_time,
                                           y      = NCDC_data$wind_speed,
                                           method = "linear",
                                           xout   = hour_time)$y
                              
NCDC_time_series$wind_dir_degrees  = approx(x     = NCDC_data$date_time,
                                           y      = NCDC_data$wind_direction,
                                           method = "linear",
                                           xout   = hour_time)$y

print(NCDC_time_series)
>>>>>>> origin/master
```

And send it to a comma delimited ASCII file
...
=======
write.table(x    = NCDC_time_series, 
>>>>>>> origin/master
