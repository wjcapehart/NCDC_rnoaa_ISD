...
start_year = unlist(strsplit(x      = ncdc_start_yymmdd,
                             split  = "-"))

start_day   = start_year[3]
start_month = start_year[2]
start_year  = start_year[1]
  
end_year = unlist(strsplit(x      = ncdc_end_yymmdd,
                           split  = "-"))

end_day   = end_year[3]
end_month = end_year[2]
end_year  = end_year[1]
...
split_ncdc = unlist(strsplit(x      = ncdc_id_code,
                             split  = ":"))

ncdc_data =  ncdc(datasetid = split_ncdc[1],
                  stationid = ncdc_id_code,
                  startdate = working_start_yymmdd,
                  enddate   = working_end_yymmdd)
